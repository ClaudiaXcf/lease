package com.greatxcf.lease.web.admin.controller.lease;
...
public class LeaseAgreementController {
    ...
    public Result<IPage<AgreementVo>> page(@RequestParam long current, @RequestParam long size, AgreementQueryVo queryVo) {
        Page<AgreementVo> page = new Page<AgreementVo>(current,size);
    ...
    public Result updateStatusById(@RequestParam Long id, @RequestParam LeaseStatus status) {
        LambdaUpdateWrapper<LeaseAgreement> leaesLambdaUpdateWrapper = new LambdaUpdateWrapper<LeaseAgreement>();
        leaesLambdaUpdateWrapper.eq(LeaseAgreement::getId,id);
        leaesLambdaUpdateWrapper.set(LeaseAgreement::getStatus,status);
        leaseAgreementService.update(leaesLambdaUpdateWrapper);
        return Result.ok();
    }
