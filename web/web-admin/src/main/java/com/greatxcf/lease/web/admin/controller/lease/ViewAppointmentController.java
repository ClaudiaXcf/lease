...
import com.greatxcf.lease.model.enums.AppointmentStatus;
import com.greatxcf.lease.web.admin.service.ViewAppointmentService;
...
public class ViewAppointmentController {
    ...
    public Result<IPage<AppointmentVo>> page(@RequestParam long current, @RequestParam long size,
        ...
        IPage<AppointmentVo> result = viewAppointmentService.pageAppointmentVo(page,queryVo);
    ...
    public Result updateStatusById(@RequestParam Long id, @RequestParam AppointmentStatus status) {
        ...
        viewAppointmentLambdaUpdateWrapper.set(ViewAppointment::getUpdateTime, new Date());
